...
function iron15_preprocess_page(&$variables) {
  ...
  if (user_is_logged_in()) {
    $variables['propose_session_link'] = l(t('<span>Propose</span>session'), 'node/add/session', array(
      'html' => TRUE,
      'attributes' => array(
        'class' => array(
          'btn',
    ...
    $variables['propose_session_link'] = l(t('<span>Propose</span>session'), 'user/login', array(
      'query' => array('destination' => 'node/add/session'),
      'html' => TRUE,
      'attributes' => array(
        'class' => array(
          'btn',
